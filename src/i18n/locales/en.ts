export default {
  ...
  auth: {
    ...
    resetStep1Desc: "Enter your email and we'll send you a 6-digit code.",
    resetStep2Title: "Enter Code",
    resetStep2Desc: "Check your email for the 6-digit code.",
    resetStep3Title: "New Password",
    sendCode: "Send Code",
    ...
    verifyEmailDesc: "We sent a 6-digit code to {email}. Enter it below.",
    verifyEmailCode: "Verification code",
    verifyEmailBtn: "Confirm Email",
    verifyEmailResend: "Resend code",
    verifyEmailResendWait: "Resend available in {sec}s",
    verifyEmailSuccess: "Email confirmed! Welcome to Mentis.",
    verifyEmailSkip: "Verify later",
  },
  ...
  teacher: {
    ...
    totalTimeMode: "Total Time",
    perQuestionMode: "Per Question",
    totalTimeModeHint: "Set a single time limit for the entire test",
  ...
  results: {
    ...
    matching: "Matching",
    // AI Grading
    aiGrading: "AI Evaluation",
    aiGradingInProgress: "AI Grading in Progress",
    aiGradingPendingDesc:
      "Some answers are still being evaluated. Results will update automatically.",
    gradedBy: "Graded by",
