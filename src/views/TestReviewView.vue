...
const loadTestDetails = async () => {
  ...
  try {
    ...
    ElMessage.error(
      error.response?.data?.detail || "Failed to load test details"
    );
  } finally {
    loading.value = false;
  }
    ...
    <el-page-header @back="goBack">
      <template #content>
        <span class="page-title">{{
          t("lobby.studentAnswers") || "Student Answers Review"
        }}</span>
      </template>
    </el-page-header>
    ...
    <div v-loading="loading" class="content">
      ...
      <el-card class="answers-card">
        ...
        <el-empty
          ...
          :description="t('common.noData') || 'No answers found'"
        />
        ...
        >
          ...
          <div class="answer-details">
            <div class="answer-row">
              <span class="label"
                >{{ t("common.studentAnswer") || "Student's Answer" }}:</span
              >
              <span
                class="value"
                :class="{
